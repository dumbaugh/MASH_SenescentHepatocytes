...
# Fig 3A-B General summary of 14 senescence gene signatures
...
# Fig 3C-J Area Under Curve analysis in four MASLD datasets
...
lapply(unique(dat_auc$variable), function(itype){
  dat_auc %>% 
...
# Fig 3K Comparisons of 14 signatures
